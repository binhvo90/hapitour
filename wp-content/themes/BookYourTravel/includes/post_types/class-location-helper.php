	...
	function location_admin_init() {
		...
		$this->location_list_custom_meta_fields = array(
			...
			array( // Post ID select box
				...
				'desc'	=> esc_html__('If checked, will show only top level locations and not child locations', 'bookyourtravel'), // description
				'id'	=> 'location_list_exclude_child_locations', // field id and name
				'type'	=> 'checkbox', // type of field
			),			
			array( // Post ID select box
