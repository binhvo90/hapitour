...
class BookYourTravel_Theme_Actions extends BookYourTravel_BaseSingleton {
	...
	function enqueue_scripts_styles() {
		...
		wp_enqueue_script( 'bookyourtravel-jquery-validate', BookYourTravel_Theme_Utils::get_file_uri ('/js/jquery.validate.min.js'), array('jquery', 'jquery-ui-datepicker'), '1.0', true );
