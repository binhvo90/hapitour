...
$exclude_child_locations = false;
if (isset($page_custom_fields['location_list_exclude_child_locations'])) {
	$exclude_child_locations = $page_custom_fields['location_list_exclude_child_locations'][0] == '1' ? true : false;
}
...
} else if ($exclude_child_locations) {
	$args['post_parent'] = 0;
}
