	...
	<?php	
		...
		<section class="three-fourth">
			...
			<script>
				...
				window.cruiseIsPricePerPerson = <?php echo (int)$cruise_obj->get_is_price_per_person(); ?>;
			...
			<?php 
			$tab = BookYourTravel_Theme_Utils::find_extra_field($tab_array, 'description');
			if (!isset($tab['hide']) || $tab['hide'] != '1') {
			?>				
			<!--description-->
			...
			<!--//description-->
			<?php }
			$tab = BookYourTravel_Theme_Utils::find_extra_field($tab_array, 'availability');
			if (!isset($tab['hide']) || $tab['hide'] != '1') {
			?>				
			<!--availability-->
			<script>
			...
			<!--//availability-->
			<?php }
			$tab = BookYourTravel_Theme_Utils::find_extra_field($tab_array, 'locations');
			if (!isset($tab['hide']) || $tab['hide'] != '1') {
			?>				
			...
			<?php } ?>	
			<?php }
			$tab = BookYourTravel_Theme_Utils::find_extra_field($tab_array, 'facilities');
			if (!isset($tab['hide']) || $tab['hide'] != '1') {
			?>				
			<!--facilities-->
			...
			<!--//facilities-->
			<?php }
			$tab = BookYourTravel_Theme_Utils::find_extra_field($tab_array, 'reviews');
			if (!isset($tab['hide']) || $tab['hide'] != '1') {
			?>							
