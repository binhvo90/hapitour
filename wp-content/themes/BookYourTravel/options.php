...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'desc' => esc_html__('Upload your website logo to go in place of default theme logo.', 'bookyourtravel'),
	...
	if ( ! function_exists( 'get_site_icon_url' ) ) {	
		...
		$options[] = array(
			...
			'desc' => esc_html__('Upload your website favicon to go in place of default theme favicon.', 'bookyourtravel'),
	...
	$options[] = array(
		...
		'desc' => esc_html__('Show car rental count in location items shown location list page', 'bookyourtravel'),
