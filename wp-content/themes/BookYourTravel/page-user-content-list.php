			...
			<article class="bookings schedules article_tour_schedule_<?php echo $schedule_result->Id; ?>">
				...
				<div class="b-info">
					<table>
						...
						<tr>
							<th><?php esc_html_e('End date', 'bookyourtravel'); ?>:</th>
							<td><?php echo $tour_type_is_repeated > 0 ? date_i18n($date_format, strtotime($schedule_result->end_date)) : esc_html__('N/A', 'bookyourtravel'); ?></td>
						</tr>
						<tr>
			...
			<article class="bookings schedules article_cruise_schedule_<?php echo $schedule_result->Id; ?>">
				...
				<div class="b-info">
					<table>
						...
						<tr>
							<th><?php esc_html_e('End date', 'bookyourtravel'); ?>:</th>
							<td><?php echo $cruise_type_is_repeated > 0 ? date_i18n($date_format, strtotime($schedule_result->end_date)) : esc_html__('N/A', 'bookyourtravel'); ?></td>
						</tr>
						<tr>
							<th><?php esc_html_e('Duration days', 'bookyourtravel'); ?>:</th>
							<td><?php echo $schedule_result->duration_days; ?></td>
...
<?php } elseif ($content_type == 'room_type' ) { ?>
		...
		<section id="room-list" class="tab-content initial">
			<article>
				<?php
					$room_type_query = $bookyourtravel_room_type_helper->list_room_types($current_author_id, array('publish', 'private', 'draft'));
		...
		<section id="room-list" class="tab-content initial">
			<article>
				<?php
					$cabin_type_query = $bookyourtravel_cabin_type_helper->list_cabin_types($current_author_id, array('publish', 'private', 'draft'));
