(function($) {
	...
	var bookingsAdmin = {
				...
				if (typeof($('#booking_datepicker_from')) !== 'undefined') {
					...
					$('#booking_datepicker_from').datepicker({
						...
						onSelect: function(dateText, inst) {
							...
							bookingsAdmin.populateAvailableEndDates(selectedDateFrom, bookingsAdmin.displayControls);
						},
						onChangeMonthYear: function (year, month, inst) {
							...
							var selectedDateFrom = bookingsAdmin.getSelectedDateFrom();
							if (selectedDateFrom) {
								bookingsAdmin.populateAvailableEndDates(selectedDateFrom, bookingsAdmin.refreshDatepickerTo);
							} 							
						}
					});
		...
		populateAvailableEndDates: function(startDate, callDelegate) {
